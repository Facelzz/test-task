...
@section('content')
    <form autocomplete="off" class="card rounded-0 shadow-none border" action="{{ route('employee.update', $employee->id) }}" enctype="multipart/form-data" method="POST" style="width: 38vw; min-width: 400px;">
        @csrf
        @method('PUT')

        <div class="card-body p-3">
            <h5 class="mb-4">Employee edit</h5>
            ...
            <div class="form-group">
                ...
                @elseif(!is_null($employee->photo))
                    <img src="/{{ $employee->photo }}" class="d-block mb-4" style="width: 5.7vw">
                @endif
                <label class="btn btn-flat btn-default btn-file" style="width: 38%; display: block;">
                    Upload photo <input  id="photo" name="photo" type="file" class="d-none">
                </label>
            ...
            <div class="form-group">
                ...
                <input id="phone_number" name="phone_number" type="text" class="form-control {{ $errors->has('phone_number')? 'is-invalid' : '' }}"  value="{{ $employee->phone_number }}">
            ...
            <div class="form-group">
                ...
                <input id="email" name="email" type="email" class="form-control {{ $errors->has('email')? 'is-invalid' : '' }}" value="{{ $employee->email }}">
                @if ($errors->has('email'))
            ...
            <div class="form-group autocomplete">
                ...
                <input id="head" name="head"
                       type="text" class="form-control {{ $errors->has('head')? 'is-invalid' : '' }}"
                       autocomplete="off" value="{{ $employee->head }}">
                @if ($errors->has('head'))
            ...
            <div class="form-group date" data-provide="datepicker" data-date-format="dd.mm.yy">
                ...
                <input id="employment_date" name="employment_date"
